                            ...
                            <div class="py-12">
                                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                    <form method="POST" enctype="multipart/form-data"
                                        action="{{ route('incomeStore') }}">
                                        {{ csrf_field() }}

                                        <div class="form-group">
                                            <label for="income">Ingreso:</label>
                                            <input type="number" class="form-control" name="income" id="income"
                                                placeholder="Ingresa un monto" value="{{ old('income') }}"
                                                class="@error('income') is-invalid @enderror">
                                            @error('income')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="description"
                                                id="description" placeholder="Ingrese motivo de transferencia"
                                        ...
                                        <div class="form-group">
                                            <label for="account_id">Hacia:</label>
